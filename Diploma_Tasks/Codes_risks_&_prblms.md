...
## Конечный выводы
После разработки тестовых программ был сделан вывод, что целесообразно использовать библиотеку duckX, так как при помощи неё не нужно лишних манипуляций с odt и xml файлами.